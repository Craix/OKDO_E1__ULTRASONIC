 ...
 */
#define PIO1_31_MODE_PULL_DOWN 0x01u

/*! @name PIO0_0 (number 54), US
  @{ */
#define PWM_PWM_PORT 0U                  /*!<@brief PORT peripheral base pointer */
#define PWM_PWM_PIN 0U                   /*!<@brief PORT pin number */
#define PWM_PWM_PIN_MASK (1U << 0U)      /*!<@brief PORT pin mask */
                                         /* @} */

/*! @name PIO1_31 (number 91), US
  @{ */
#define PWM_INT_PORT 1U                   /*!<@brief PORT peripheral base pointer */
#define PWM_INT_PIN 31U                   /*!<@brief PORT pin number */
#define PWM_INT_PIN_MASK (1U << 31U)      /*!<@brief PORT pin mask */
                                          /* @} */
 ...
 *
 */
void PWM(void); /* Function assigned for the Cortex-M33 (Core #0) */
